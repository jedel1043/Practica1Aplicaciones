                ...
                if instr == Instruction.UPLOAD:
                    ...
                    if os.path.exists(relpath):
                        with open(relpath, 'rb') as f:
                            ...
                            print(f"Getting ready to send file \"{relpath}\" of {filelen} bytes")
                            ...
                            print("Correcly sent file \"" + relpath + "\" to server")
                            print()
                    else:
                    ...
                    if os.path.exists(relpath):
                        if os.path.isdir(relpath):
                            print(f"Getting ready to delete directory \"{relpath}\"")

                            shutil.rmtree(relpath)

                            print("Correcly removed path \"" + relpath + "\" from server")
                            print()
                        else:
                            print(f"Getting ready to delete file \"{relpath}\"")

                            os.remove(relpath)

                            print("Correcly removed file \"" + relpath + "\" from server")
                            print()
                            
                    else:
                        print(f"Path \"{relpath}\" not found in server")
                else:
                    print(f"Unknown instruction {instr} sent by client {addr}")
